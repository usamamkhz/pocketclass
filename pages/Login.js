						...
						<form onSubmit={(e) => handleLogin(e)}>
							...
							<div className="mt-8 flex justify-between items-center">
								...
								<p
									...
									className="font-medium text-base text-logo-red cursor-pointer active:scale-90 transition duration-150 hover:scale-105 transition transform duration-200 ease-out"
								>
									Forgot Password?
								</p>
							</div>
							<div className="mt-8 flex flex-col gap-y-4">
								{!loading ? (
									<button
										type="submit"
										className="active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-logo-red rounded-xl text-white font-bold text-lg"
									>
										Sign in
									</button>
								) : (
							...
							<div className="mt-8 flex justify-center items-center">
								...
								<button
									...
									className="ml-2 font-medium text-base text-logo-red cursor-pointer active:scale-90 transition duration-150 hover:scale-105 transition transform duration-200 ease-out"
								>
									Sign up
								</button>
							</div>
